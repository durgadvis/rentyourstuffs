 ...
 * #L%
 */
package com.rentmystuffs.sample.vendor.nullPaymentGateway.web.controller;

import com.rentmystuffs.sample.payment.service.gateway.NullPaymentGatewayHostedConfiguration;
