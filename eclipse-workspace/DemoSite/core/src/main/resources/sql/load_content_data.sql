...
INSERT INTO BLC_PAGE_FLD(PAGE_FLD_ID, FLD_KEY, VALUE, PAGE_ID) VALUES (3, 'body', '<h2 style="text-align:center;">Coming Soon...</h2><h4 style="text-align:center;">Please wait</h4>', 2);

-- This creates an empty new to hot sauce 
INSERT INTO BLC_PAGE_FLD(PAGE_FLD_ID, FLD_KEY, VALUE, PAGE_ID) VALUES (4, 'body', '<h2 style="text-align:center;">Coming Soon..Please wait</h2>', 3);
